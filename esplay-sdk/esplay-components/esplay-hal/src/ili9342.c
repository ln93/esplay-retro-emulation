...
{
	int duty = DUTY_MAX * ((value + 5) * 0.0095f);
...
static void backlight_init()
{
	...
	ledc_set_fade_time_and_start(LEDC_LOW_SPEED_MODE, LEDC_CHANNEL_0, (LCD_BACKLIGHT_ON_VALUE) ? DUTY_MAX : 0, 500, LEDC_FADE_NO_WAIT);
